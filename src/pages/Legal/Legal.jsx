  ...
  ms: {
    terms: {
      ...
      sections: [
        ...
        { h: '4. Pemulangan Wang', b: 'Untuk pakej Whitelabel, jaminan 30 hari dan kelayakan coaching pada halaman tawaran whitelabel terpakai. Bagi kod permainan biasa: oleh kerana ini produk digital yang dihantar serta-merta, bayaran tidak boleh dipulangkan selepas kod akses dijana dan dihantar.' },
    ...
    privacy: {
      ...
      sections: [
        ...
        { h: '4. Penyimpanan Data', b: 'Data pesanan digunakan untuk rekod jualan, sokongan, pemulihan kod akses dan pengiraan komisyen affiliate.' },
        { h: '5. Akaun Affiliate & Kuki', b: 'Pendaftaran affiliate mengumpul nama, emel, telefon dan kata laluan yang disimpan sebagai hash. Kuki sesi log masuk bertahan 7 hari. Link affiliate menggunakan kuki rujukan 30 hari dan pengecam pelawat tanpa nama selama 365 hari untuk mengukur trafik. Link terakhir pada pelayar yang sama menerima atribusi jualan. Affiliate melihat jumlah jualan dan komisyen sendiri tanpa nama, emel, telefon atau kod akses pembeli.' },
        { h: '6. Hak Anda', b: 'Anda boleh meminta kami memadam maklumat anda pada bila-bila masa dengan menghubungi kami.' },
      ],
    },
  },
  en: {
    terms: {
      ...
      sections: [
        ...
        { h: '4. Refunds', b: 'Whitelabel packages follow the 30-day guarantee and coaching eligibility stated on the whitelabel offer page. For standard game access codes: as this is a digital product delivered instantly, payments are non-refundable once the access code is generated and delivered.' },
    ...
    privacy: {
      ...
      sections: [
        ...
        { h: '4. Data Storage', b: 'Order data is used for sales records, support, access-code recovery and affiliate commission accounting.' },
        { h: '5. Affiliate Accounts & Cookies', b: 'Affiliate registration collects name, email, phone and a hashed password. Login sessions last 7 days. Referral links use a 30-day attribution cookie and an anonymous visitor identifier lasting 365 days to measure traffic. The last referral link in the same browser receives sales attribution. Affiliates see their own sales and commissions without buyer names, emails, phone numbers or access codes.' },
        { h: '6. Your Rights', b: 'You may ask us to delete your information at any time by contacting us.' },
      ],
    },
  },
};
