...
export function existingWhitelabelOrder(requestKey) {
  return Object.values(getOrders()).find(o=>o.package==='whitelabel' && o.whitelabelSlot && o.whitelabelRequestKey===requestKey);
}
